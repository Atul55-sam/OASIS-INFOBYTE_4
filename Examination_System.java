...
class OnlineTest extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 2) {
            ...
            jb[0].setText("James Gosling");
            jb[1].setText("Dennis Ritche");
            jb[2].setText("Alan Kay");
            jb[3].setText("Guido van Rossum");
        }
        if (current == 3) {
        ...
        if (current == 5) {
            ...
            jb[0].setText("Exception");
            jb[1].setText("Polymorphism");
            jb[2].setText("Inheritance");
        ...
        if (current == 6) {
            ...
            jb[0].setText("Polymorphism");
            jb[1].setText("Inheritance");
            jb[2].setText("Encaptulation");
            jb[3].setText("Abstraction");
        }
        if (current == 7) {
            l.setText("8) Which among the following feature is not in the general definition of OOPS?");
            jb[0].setText("Efficient Code");
            jb[1].setText("Duplicate & Redundant Data");
            jb[2].setText("Code Reusability");
